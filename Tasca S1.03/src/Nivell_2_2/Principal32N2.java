...
public class Principal32N2 {
	
	static Set <Restaurant> llistaRestaurants=new HashSet<Restaurant>();
	//static Set <Restaurant> llistaRestaurants=new TreeSet<Restaurant>();
	...
	public static void mostrarLlistaOrdenada() {
		
		ArrayList <Restaurant> llistaOrdenada=new ArrayList<Restaurant>(llistaRestaurants);
		//List <Restaurant> llistaOrdenada=llistaRestaurants.stream().sorted().collect(Collectors.toList()); 
